...
public class ParserRealigner {
    ...
    public String realign(String source) throws ParseException {
        JavaParseResult parseResult = JdJavaSourceParser.parse(source);
        return format(parseResult);
    }

    public String format(JavaParseResult parseResult) {
        ...
        String internalTypeName = parseResult.getInternalTypeName();
