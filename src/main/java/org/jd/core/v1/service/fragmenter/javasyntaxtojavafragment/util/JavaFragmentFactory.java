...
public final class JavaFragmentFactory {
    ...
    public static void addEndSingleStatementMethodBody(List<Fragment> fragments, StartBodyFragment start) {
        fragments.add(new EndBodyFragment(0, 1, 1, 6, "End single statement method body", start));
    }
    ...
    public static void addEndStatementsInSwitchExpressionBlockInParameter(List<Fragment> fragments, StartBlockFragment start) {
    ...
    public static StartBlockFragment addStartStatementsInSwitchExpressionBlock(List<Fragment> fragments) {
        StartBlockFragment fragment = new StartBlockFragment(0, 1, 2, 14, "Start statements in SwitchExpression block");
        fragments.add(fragment);
        fragments.add(new SpacerFragment(0, 0, Integer.MAX_VALUE, 14, "Start statements in SwitchExpression block spacer"));
        return fragment;
    }
