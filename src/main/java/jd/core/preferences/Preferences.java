...
public final class Preferences {
	...
	public Preferences(Map<String, String> preferences) {
		this.setUnicodeEscape(Boolean.parseBoolean(preferences.getOrDefault(Preferences.ESCAPE_UNICODE_CHARACTERS, Boolean.FALSE.toString())));
		this.setShowPrefixThis(!Boolean.parseBoolean(preferences.getOrDefault(Preferences.OMIT_THIS_PREFIX, Boolean.FALSE.toString())));
		this.setShowDefaultConstructor(Boolean.parseBoolean(preferences.getOrDefault(Preferences.DISPLAY_DEFAULT_CONSTRUCTOR, Boolean.FALSE.toString())));
		this.setRealignmentLineNumber(Boolean.parseBoolean(preferences.getOrDefault(Preferences.REALIGN_LINE_NUMBERS, Boolean.FALSE.toString())));
		this.setShowLineNumbers(Boolean.parseBoolean(preferences.getOrDefault(Preferences.WRITE_LINE_NUMBERS, Boolean.FALSE.toString())));
		this.setWriteMetaData(Boolean.parseBoolean(preferences.getOrDefault(Preferences.WRITE_METADATA, Boolean.FALSE.toString())));
	}
