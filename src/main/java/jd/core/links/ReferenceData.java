...
public class ReferenceData {
	...
	public boolean isAType() { return this.getName() == null; }
	public boolean isAField() { return this.getDescriptor() != null && this.getDescriptor().charAt(0) != '('; }
	public boolean isAMethod() { return this.getDescriptor() != null && this.getDescriptor().charAt(0) == '('; }
	public boolean isAConstructor() { return StringConstants.INSTANCE_CONSTRUCTOR.equals(this.getName()); }
