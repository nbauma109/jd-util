...
public class HyperlinkReferenceDataTest {
    ...
    public void test() throws Exception {
        ReferenceData referenceData = new ReferenceData(StringConstants.JAVA_LANG_OBJECT, "hashCode", "()I", null);
        ...
        assertEquals("ReferenceData [typeName=java/lang/Object, name=hashCode, descriptor=()I, owner=null, enabled=false]", hyperlinkReferenceData.toString());
    }
}
